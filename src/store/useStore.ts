    ...
    try {
      ...
      set({
        ...
        progress: {
          ...
          weeklyStreak: progress.weekly_streak,
          rank: progress.rank,
          placementScore: progress.placement_score,
          dsaScore: progress.dsa_score,
          aptitudeScore: progress.aptitude_score,
          interviewScore: progress.interview_score,
          resumeScore: progress.resume_score,
          consistencyScore: progress.consistency_score,
